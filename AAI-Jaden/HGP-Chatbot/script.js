...
const rules = [
  ...
  { match: ["AAI", "Applied Artificial Intelligence"], reply: "AA is using data to make better decisions. Want a quick example?" },
  { match: ["my", "knee hurts"], reply: "Which knee? Disney!" },
  { match: ["dogs", "can't", "operate", "mri", "machines"], reply: "But catscan!" },
];
